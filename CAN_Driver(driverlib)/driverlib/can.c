...
#include "C:/Keil_v5/EE319Kware/inc/hw_can.h"
#include "C:/Keil_v5/EE319Kware/inc/hw_ints.h"
#include "C:/Keil_v5/EE319Kware/inc/hw_nvic.h"
#include "C:/Keil_v5/EE319Kware/inc/hw_memmap.h"
#include "C:/Keil_v5/EE319Kware/inc/hw_types.h"
#include "C:/Keil_v5/EE319Kware/driverlib/can.h"
#include "C:/Keil_v5/EE319Kware/driverlib/debug.h"
#include "C:/Keil_v5/EE319Kware/driverlib/interrupt.h"
#include "C:/Keil_v5/EE319Kware/inc/hw_types.h"
...
CANInit(unsigned long ulBase)
{
    ...
    CANRegWrite(ulBase + CAN_O_IF1CMSK, CAN_IF1CMSK_WRNRD | CAN_IF1CMSK_ARB |
                CAN_IF1CMSK_CONTROL);             //used to transfer data/control from interface registers to message objects (MNUM)
    CANRegWrite(ulBase + CAN_O_IF1ARB2, 0);       //message identifier =0 , MSGVAL =0
    CANRegWrite(ulBase + CAN_O_IF1MCTL, 0);       //clear some conrol signals

    //
    // Loop through to program all 32 message objects (to apply these configurations to all message objects)
    //
    for(iMsg = 1; iMsg <= 32; iMsg++)
    {
        ...
        //
        CANRegWrite(ulBase + CAN_O_IF1CRQ, iMsg);    //MNUM = iMsg
    }
    ...
    // message objects.
		CANRegWrite(ulBase + CAN_O_IF1CMSK, CAN_IF1CMSK_NEWDAT |
                CAN_IF1CMSK_CLRINTPND);   // when NEWDAT and CLRINTPND are set, WRNRD is cleared(we read from the buffer)
    
    //
    // Loop through to program all 32 message objects 
		// (to apply the WRNRD=0, so that interrupt pending and new data conditions are cleared)
    //
    for(iMsg = 1; iMsg <= 32; iMsg++)
    {
        //
    ...
    //
    CANRegRead(ulBase + CAN_O_STS);   //to clear all interrupts
}
...
//*****************************************************************************
void
CANRetrySet(unsigned long ulBase, char bAutoRetry)
{
...
CANMessageGet(unsigned long ulBase, unsigned long ulObjID,
              tCANMsgObject *pMsgObject, char bClrPendingInt)
{
    unsigned short usCmdMaskReg;
    unsigned short usMaskReg0, usMaskReg1;
    unsigned short usArbReg0, usArbReg1;
