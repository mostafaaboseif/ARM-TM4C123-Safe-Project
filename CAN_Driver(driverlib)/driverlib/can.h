...
extern char CANErrCntrGet(unsigned long ulBase, unsigned long *pulRxCount,
...
extern char CANRetryGet(unsigned long ulBase);
extern void CANRetrySet(unsigned long ulBase, char bAutoRetry);
