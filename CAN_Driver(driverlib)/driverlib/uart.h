...
extern void UARTEnableSIR(unsigned long ulBase, char bLowPower);
extern void UARTDisableSIR(unsigned long ulBase);
extern char UARTCharsAvail(unsigned long ulBase);
extern char UARTSpaceAvail(unsigned long ulBase);
extern long UARTCharGetNonBlocking(unsigned long ulBase);
extern long UARTCharGet(unsigned long ulBase);
extern char UARTCharPutNonBlocking(unsigned long ulBase,
                                       unsigned char ucData);
extern void UARTCharPut(unsigned long ulBase, unsigned char ucData);
extern void UARTBreakCtl(unsigned long ulBase, char bBreakState);
extern char UARTBusy(unsigned long ulBase);
...
extern unsigned long UARTIntStatus(unsigned long ulBase, char bMasked);
