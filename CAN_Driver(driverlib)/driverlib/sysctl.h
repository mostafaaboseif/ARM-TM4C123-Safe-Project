...
extern char SysCtlPinPresent(unsigned long ulPin);
extern char SysCtlPeripheralPresent(unsigned long ulPeripheral);
...
extern void SysCtlPeripheralClockGating(char bEnable);
...
extern unsigned long SysCtlIntStatus(char bMasked);
...
extern void SysCtlIOSCVerificationSet(char bEnable);
extern void SysCtlMOSCVerificationSet(char bEnable);
extern void SysCtlPLLVerificationSet(char bEnable);
